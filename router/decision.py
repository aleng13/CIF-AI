...
def handle_incoming_email(email_event):
    ...
    conv_id = conv.id
    repository.save_message(conv_id, sender=email_event.from_address, subject=email_event.subject, body=email_event.body_text, mdata={'raw': email_event.raw})
    # 2. RAG search
    ...
    repository.save_message(conv_id, sender='AI', subject='Re: ' + (email_event.subject or ''), body=reply.reply_text, mdata={'summary': reply.summary})
